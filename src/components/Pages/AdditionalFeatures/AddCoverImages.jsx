      ...
      return (
        <>
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-[#7b1fa2]"> Add Cover Image</h2>
            <p className="text-gray-700">
                This is the 'Add Cover Image' area in Mini Lessons Academy (Mini Lessons), the fastest way for coaches, educators, and creators to transform their expertise into polished digital products like courses, books, audiobooks, and more, without complex technical skills or endless content creation burnout.
            </p>
            <p className="text-gray-700">        
